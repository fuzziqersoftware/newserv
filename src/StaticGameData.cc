...
static const std::vector<FloorDefinition> floor_defs{
    ...
    {Episode::EP1, 0x0B, 0x0B, 0x0B, 0x02, F_V1 | F_BOSS,  "Dragon",              "Dgn",  "Under the Dome (Dragon)", {"dragon", "dgn"}},
    {Episode::EP1, 0x0C, 0x0C, 0x0C, 0x05, F_V1 | F_BOSS,  "DeRolLe",             "DRL",  "Underground Channel (De Rol Le)", {"derolle", "drl"}},
    {Episode::EP1, 0x0D, 0x0D, 0x0D, 0x07, F_V1 | F_BOSS,  "VolOpt",              "VO",   "Monitor Room (Vol Opt)", {"volopt", "vo"}},
    {Episode::EP1, 0x0E, 0x0E, 0x0E, 0x09, F_V1 | F_BOSS,  "DarkFalz",            "DF",   "???? (Dark Falz)", {"darkfalz", "df"}},
    {Episode::EP1, 0x0F, 0x0F, 0x0F, 0xFF, F_V1 | F_LOBBY, "Lobby",               "Lby",  "Lobby", {"lobby"}},
    {Episode::EP1, 0x10, 0x10, 0x10, 0x09, F_V2,           "Battle1",             "B1",   "Spaceship", {"battle1", "b1", "spaceship", "ss"}},
    {Episode::EP1, 0x11, 0x11, 0x11, 0x09, F_V2,           "Battle2",             "B2",   "Palace", {"battle2", "b2", "palace", "pl", "temple", "tpl"}},

    {Episode::EP2, 0x00, 0x00, 0x12, 0xFF, F_GCN | F_CITY, "Pioneer2",            "Lab",  "Lab", {"pioneer2", "p2", "lab", "labo", "city"}},
    {Episode::EP2, 0x01, 0x13, 0x13, 0x00, F_GCN,          "VRTempleAlpha",       "VRTA", "VR Temple Alpha", {"vrtemplealpha", "templealpha", "vrta", "ta"}},
    {Episode::EP2, 0x02, 0x14, 0x14, 0x01, F_GCN,          "VRTempleBeta",        "VRTB", "VR Temple Beta", {"vrtemplebeta", "templebeta", "vrtb", "tb"}},
    {Episode::EP2, 0x03, 0x15, 0x15, 0x02, F_GCN,          "VRSpaceshipAlpha",    "VRSA", "VR Spaceship Alpha", {"vrspaceshipalpha", "spaceshipalpha", "vrsa", "sa"}},
    {Episode::EP2, 0x04, 0x16, 0x16, 0x03, F_GCN,          "VRSpaceshipBeta",     "VRSB", "VR Spaceship Beta", {"vrspaceshipbeta", "spaceshipbeta", "vrsb", "sb"}},
    {Episode::EP2, 0x05, 0x17, 0x17, 0x07, F_GCN,          "CentralControlArea",  "CCA",  "Central Control Area", {"centralcontrolarea", "cca"}},
    {Episode::EP2, 0x06, 0x18, 0x18, 0x04, F_GCN,          "JungleNorth",         "JN",   "Jungle Area North", {"junglenorth", "jn"}},
    {Episode::EP2, 0x07, 0x19, 0x19, 0x05, F_GCN,          "JungleEast",          "JE",   "Jungle Area East", {"jungleeast", "je"}},
    {Episode::EP2, 0x08, 0x1A, 0x1A, 0x06, F_GCN,          "Mountain",            "Mtn",  "Mountain Area", {"mountain", "mtn"}},
    {Episode::EP2, 0x09, 0x1B, 0x1B, 0x07, F_GCN,          "Seaside",             "SS",   "Seaside Area", {"seaside", "ss"}},
    {Episode::EP2, 0x0A, 0x1C, 0x1C, 0x08, F_GCN,          "SeabedUpper",         "SU",   "Seabed Upper Levels", {"seabedupper", "su"}},
    {Episode::EP2, 0x0B, 0x1D, 0x1D, 0x09, F_GCN,          "SeabedLower",         "SL",   "Seabed Lower Levels", {"seabedlower", "sl"}},
    {Episode::EP2, 0x0C, 0x1E, 0x1E, 0x08, F_GCN | F_BOSS, "GalGryphon",          "GG",   "Cliffs of Gal Da Val (Gal Gryphon)", {"galgryphon", "gg"}},
    {Episode::EP2, 0x0D, 0x1F, 0x1F, 0x09, F_GCN | F_BOSS, "OlgaFlow",            "OF",   "Test Subject Disposal Area (Olga Flow)", {"olgaflow", "of"}},
    {Episode::EP2, 0x0E, 0x20, 0x20, 0x02, F_GCN | F_BOSS, "BarbaRay",            "BR",   "VR Temple Final (Barba Ray)", {"barbaray", "br"}},
    {Episode::EP2, 0x0F, 0x21, 0x21, 0x04, F_GCN | F_BOSS, "GolDragon",           "GD",   "VR Spaceship Final (Gol Dragon)", {"goldragon", "gd"}},
    {Episode::EP2, 0x10, 0xFF, 0x22, 0x07, F_V3,           "SeasideNight",        "SSN",  "Seaside Area (night)", {"seasidenight", "sn"}},
    {Episode::EP2, 0x11, 0xFF, 0x23, 0x09, F_V3,           "Tower",               "Twr",  "Control Tower", {"tower", "twr"}},
    ...
    {Episode::EP4, 0x09, 0xFF, 0x2C, 0x09, F_V4 | F_BOSS,  "SaintMilion",         "SM",   "Meteor Impact Site", {"saintmilion", "sm"}},
    {Episode::EP4, 0x0A, 0xFF, 0x2E, 0xFF, F_V4,           "TestMap",             "TM",   "Test Map", {"purgatory", "test"}},
    // clang-format on
};
